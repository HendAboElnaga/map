...
async function updateMetrics() {
  try {
    const response = await fetch('assets/data/chart2_dynamic.json?ts=' + Date.now());
...
//===========================================================
// ======= New Chart 4 Script =======
fetch('assets/data/chart4_data_after_date_split.json')
  .then(res => res.json())
  .then(data => {
    // === Trend Chart Data ===
  ...
  // ===== Apps Traffic Status =====
fetch('assets/data/apps_status.json')
  .then(res => res.json())
  .then(data => {
  ...
  //journey
fetch('assets/data/task_referral_dashboard_data.json')
  .then(res => res.json())
  .then(data => {
